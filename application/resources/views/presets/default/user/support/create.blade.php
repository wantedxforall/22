                ...
                <div class="dashboard-card-wrap mt-0">
                    ...
                    @csrf
                        <div class="row gy-4">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="email_address" class="form--label">@lang('Email Address')</label>
                                    <div class="input--group">
                                        <input type="email" name="email" value="{{@$user->email}}" class="form--control" id="email_address" required readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
