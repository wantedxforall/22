...
class ReportController extends Controller
{
    ...
    public function points(\App\Services\ReportingService $reporting)
    {
        return response()->json([
            'total_points_spent' => $reporting->getTotalPointsSpent(),
            'most_redeemed_items' => $reporting->getMostRedeemedItems(),
        ]);
    }
}
